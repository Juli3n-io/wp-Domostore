	...
	class CR_Checkout {
	  ...
	  public function __construct() {
		...
		public function display_cr_checkbox() {
			...
			$output .= '<input type="checkbox" class="woocommerce-form__input woocommerce-form__input-checkbox input-checkbox" name="cr_customer_consent" id="cr_customer_consent" />';
