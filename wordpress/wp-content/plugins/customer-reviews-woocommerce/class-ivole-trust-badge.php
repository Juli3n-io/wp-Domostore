    ...
    class Ivole_Trust_Badge
    {
        ...
        public function show_trust_badge()
        {
          ...
          if( 'wdp' === $this->shortcode_atts['type'] ) {
            ...
            $return .= '<img id="ivole_trustbadgefi_' . $this->shortcode_atts['type'] . '" class="' . $class_img . '" src="' . 'https://www.cusrev.com/badges/' . Ivole_Email::get_blogurl() . '-' . $this->shortcode_atts['type'] . $l_suffix . '.png' . '" alt="' . __( 'Trust Badge', IVOLE_TEXT_DOMAIN ) . '">';
            $return .= '</picture>';
